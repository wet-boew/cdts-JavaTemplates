...
<p>
    This setting determines the application title for your site. Set programmatically by calling the <code class="wb-prettify">setApplicationTitleText</code> method in your custom bean class.
</p>
...
<h2>Secure Icon</h2>
<p>
    Call the <code class="wb-prettify">setShowSecureIcon</code> method in your custom bean class to show or hide the secure icon.
</p>
<div class="wb-prettify all-pre lang-c# linenums">
    <pre>
@Override
