...
public class MenuSection
{
    ...
    public void setName(String sectionName) { this.name = sectionName; } 
    public String getName() { return this.name; }

    public void setLink(String sectionLink) { this.link = sectionLink; }
    public String getLink() { return this.link; }
    
    public void setItems(ArrayList<Link> menuLinks) { this.items = menuLinks; }
    public ArrayList<Link> getItems() { return this.items; }
}