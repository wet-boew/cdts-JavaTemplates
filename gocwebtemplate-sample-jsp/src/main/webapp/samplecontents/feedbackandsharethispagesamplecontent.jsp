...
<ul>
    ...
    <li>or set the property programmatically via the <code class="wb-prettify">setFeedbackText</code> method and optionally the <code class="wb-prettify">setFeedbackTextFr</code> method in your custom bean class.</li>
    ...
    <li>or set the property programmatically via the <code class="wb-prettify">setFeedbackTheme</code> method in your custom bean class.</li>
    ...
    <li>or set the property programmatically via the <code class="wb-prettify">setFeedbackSection</code> method in your custom bean class.</li>
</ul>
<div class="wb-prettify all-pre lang-vb linenums">
	<pre>
@Override
