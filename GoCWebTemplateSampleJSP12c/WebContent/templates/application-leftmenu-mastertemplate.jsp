...
<!--<![endif]-->
	...
	<body vocab="http://schema.org/" typeof="WebPage">		
        ...
        <script type="text/javascript">
            ...
            defTop.outerHTML = wet.builder.appTop(<s:property escape="false" value="#goctemplateclientbean.renderAppTop" />);
        </script>
        <div class="container">
        	<div class="row">
		        ...
		        <nav class="wb-sec col-md-3 col-md-pull-9" typeof="SiteNavigationElement" id="wb-sec" role="navigation">
		        	<!-- Write closure fall-back static file -->
                    <s:property escape="false" value="%{#applicationscopebean.getStaticFile(#goctemplateclientbean.staticFallbackFilePath, #request.wettheme, 'secMenu-'.concat(#goctemplateclientbean.twoLetterCultureLanguage).concat('.html'))}" />
		        </nav>
		        <!-- Write closure template -->
	            <script type="text/javascript">
	                var secondarymenu = document.getElementById("wb-sec");
	                secondarymenu.innerHTML = wet.builder.secmenu({
	                	<s:property value="#goctemplateclientbean.leftMenuSections" />
	                });
	            </script>	
        	</div>
        </div>        
        <div id="def-footer">
            <!-- Write closure fall-back static file -->
            <s:property escape="false" value="%{#applicationscopebean.getStaticFile(#goctemplateclientbean.staticFallbackFilePath, #request.wettheme, 'appFooter-'.concat(#goctemplateclientbean.twoLetterCultureLanguage).concat('.html'))}" />
        </div>
        <!-- Write closure template -->
        <script type="text/javascript">
            var defFooter = document.getElementById("def-footer");
            defFooter.outerHTML = wet.builder.appFooter(<s:property escape="false" value="#goctemplateclientbean.renderAppFooter" />);
        </script>
        <!-- Write closure template -->
		<script type="text/javascript">
